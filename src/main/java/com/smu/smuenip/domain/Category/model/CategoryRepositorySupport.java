...
@Repository
public class CategoryRepositorySupport extends QuerydslRepositorySupport implements CustomCategoryRepository {
    ...
    @Override
    public Category findCategoryByDetailCategoryOrSubCategory(String detailCategory, String subCategory) {
