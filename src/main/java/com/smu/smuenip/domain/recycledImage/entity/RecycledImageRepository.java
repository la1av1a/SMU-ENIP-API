...
public interface RecycledImageRepository extends JpaRepository<RecycledImage, Long> {
    @Query(value = "SELECT new com.smu.smuenip.application.recycle.dto.RecycledImageResponseDto(p.purchasedDate, u.userId, r.id, r.recycledImageUrl, r.isChecked, r.isApproved) " +
    ...
    List<RecycledImageResponseDto> findRecycledResponseDtoByCheckedAndApprovedAndUserId(Long userId, boolean isApproved);
    ...
    List<RecycledImageResponseDto> findRecycledResponseDtoByUserIdAndDate(Long userId, LocalDate date);
    ...
    List<RecycledImageResponseDto> findRecycledResponseDtoByUserIdAndDateAndIsRecycled(Long userId, LocalDate date, boolean isRecycled);
    ...
    List<RecycledImageResponseDto> findRecycledImagesByDateAndIsRecycled(LocalDate date, boolean isRecycled);
